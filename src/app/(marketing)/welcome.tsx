...
const FAQ: { q: string; a: string }[] = [
  ...
  { q: 'TakeWord бесплатный?', a: '3 скана в день бесплатно, без карты. Premium снимает лимит и открывает все языки.' },
  ...
  return (
    <View style={styles.page}>
      <Head>
        ...
        <meta
          name="description"
          content="TakeWord превращает мир вокруг в словарь: наведи камеру на предмет — получи слово, перевод, произношение и карточку с интервальным повторением. 3 скана в день бесплатно, без карты."
        />
        <link rel="canonical" href={`${SITE_URL}/welcome`} />
        <meta property="og:title" content="TakeWord — учи язык через камеру" />
        <meta
          property="og:description"
          content="Наведи камеру на предмет — поймай слово, перевод, произношение и карточку для повторения. 3 скана в день бесплатно."
        />
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.container}>
          ...
          <Section header="Тарифы">
            <Group>
              <PriceRow name="Free" sub="3 скана в день · один язык" price="$0" />
